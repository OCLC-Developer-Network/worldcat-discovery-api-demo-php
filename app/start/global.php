...
AccessToken::$authorizationServer =  Config::get('app.AuthorizationServerURL');
...
$accessToken = Session::get('wskey')->getAccessTokenWithClientCredentials(Config::get('app.institutionID'), Config::get('app.institutionID'));
